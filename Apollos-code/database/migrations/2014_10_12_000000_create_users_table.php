...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('name', 20); // Varchar(250 caracteres máx)
            $table->string('last_name', 25); // Varchar(250 caracteres máx)
            ...
            $table->string('name_artist', 30)->nullable(); // Varchar(250 caracteres máx)
