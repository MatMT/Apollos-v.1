...
const fila_2 = document.querySelector('.slider-2');
const items_2 = document.querySelector('.card-2');

const fecha_izquierda_2 = document.getElementById('flecha-izquierda-2');
const fecha_derecha_2 = document.getElementById('flecha-derecha-2');
