            ...
            <div class="signup-container min-h-screen w-full">
                <div class="center-form flex items-center justify-center min-h-screen">
                    ...
                    <div class="form-work my-10 p-6 rounded-md">
                        ...
                        <h1 class="mt-4 font-titulo text-lg font-semibold text-center">Panel Admin</h1>

                        <div class="session-form-container flex justify-center">
                            <form action="{{ route('loginAdmin.store') }}" method="post" class="session-form"
                                novalidate>
                                @csrf
                                ...
                                <div class="input-container">
                                    ...
                                    <input type="email" name="email" id="login-email" class="form-input" required
                                        value="{{ old('email') }}" autocomplete="off" placeholder="Usuario">
                                </div> {{-- input-container --}}
                                ...
                                <h2 class="block text-center mt-5 text-gray-900">¿No tienes una cuenta?<a
                                        href="{{ route('signup') }}" class=" block"> <span
                                            class="font-bold hover:text-slate-50 transition all">Regístrate</span></a>
                                </h2>
