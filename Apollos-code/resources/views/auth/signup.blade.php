...
<body class="text-base">
    ...
    <div class="body h-full w-full min-h-screen">
        <div class="content h-screen w-screen bg-slate-600">
            ...
            <div class="signup-container float-right min-h-screen w-full bg-white">
                <div class="center-form flex items-center justify-center h-screen">
                    <div class="form-work">
                        <div class="logo flex justify-center items-center">
                            <img src="{{ asset('assets/apolloLogoComplete.png') }}"
                                class="brightness-0 block text-center">
                        </div>
                        ...
                        <div class="session-form-container flex justify-center">
                            <form action="{{ route('signup.store') }}" method="post" class="session-form"
                                ...
                                <div class="input-container">
                                    <span class="icon"><img
                                            src="{{ asset('assets/icons/userIconWht.png') }}"></span>
                                ...
                                <div class="input-container">
                                    <span class="icon"><img
                                            src="{{ asset('assets/icons/mailIconWht.png') }}"></span>
                                ...
                                <div class="input-container">
                                    <span class="icon"><img
                                            src="{{ asset('assets/icons/lockIconWht.png') }}"></span>
