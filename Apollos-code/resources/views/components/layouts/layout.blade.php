...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&family=Montserrat+Alternates:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Righteous&display=swap" rel="stylesheet">
    ...
    <header class="p-5 text-white ">
        ...
        <div class="box-header w-full h-28 flex items-center justify-between p-5">
            ...
            <ul class="flex mx-10 text-lg items-center">
                ...
                <li class="mx-8 {{$active_2 ?? 'font-normal'}} {{$active ?? 'normal'}} {{$active_bg ?? ''}}"><a href="{{ route('main')}}"><i class="fi fi-rs-home"></i>Home</a></li>
                <li class="mx-8"><a href="{{ route('biblioteca')}}"><i class="fi fi-rs-apps"></i></i>Tu Biblioteca</a></li>
            ...
            <div class="profile flex h-3/4 items-center mx-5">
                <h2 class="font-titulo w-32 border-r-2 border-zinc-50 mr-10">Mateo987</h2>
