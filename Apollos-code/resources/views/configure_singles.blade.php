...
@section('titulo')
    Actualizar datos de el sencillo
@endsection
...
@section('contenido')
        ...
        {{-- <div class="col-md-8">
            ...
            {{-- Intento new name sencillo --}}
            <div class="row mb-3">
                <div class="form-group mt-3">
                    <label for="new_name_sencillo">Actualiza Nombre de tu sencillo</label>
                    <input type="text" name="new_name_sencillo" value="{{ Auth::user()->name_song }}"
                        class="form-control @error('new_name_sencillo') is-invalid @enderror" required>
