...
@section('content')
    ...
    <div class="contenedor_lista">
        <div class="cancion_todo text-lg">
            <div class="imagen_cancion"><img loading="lazy" src="http://127.0.0.1:8000/assets/artistas-pic/shawn_album.jpg"
                    alt="No carga imagen" class="w-[55px]  rounded min-w-[40px]"></div>
    ...
    <div class="contenedor_lista">
        <div class="album_todo text-lg">
            <div class="imagen_album"><img loading="lazy" src="http://127.0.0.1:8000/assets/artistas-pic/shawn_album.jpg"
                    alt="No carga imagen" class="w-[55px]  rounded min-w-[40px]"></div>
