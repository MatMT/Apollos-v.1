            ...
            <form action="{{ route('song.settings.store', ['user' => $user, 'song' => $song->id]) }}" method="POST"
                ...
                <div class="row mb-3">
                    <div class="form-group mt-3">
                        <label for="new_name_song">Actualiza el nombre de
                            {{ $song->sencillo ? 'tu sencillo' : 'tu canción' }}</label>
                ...
                @else
                    ...
                    <label for="genero" class="genero mb-2 block uppercase text-gray-800 font-bold">Género</label>
                    <p class="pb-3">Si deseas editar el género de la canción debes editar el género de su respectivo álbum
                    </p>
                @endif
